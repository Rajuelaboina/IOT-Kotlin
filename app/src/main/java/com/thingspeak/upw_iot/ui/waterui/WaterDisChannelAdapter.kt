...
import com.thingspeak.upw_iot.databinding.WaterdisItemBinding
...
class WaterDisChannelAdapter: RecyclerView.Adapter<WaterDisChannelAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(DataBindingUtil.inflate(LayoutInflater.from(parent.context), R.layout.waterdis_item,parent,false))
    }
    ...
    class MyViewHolder(itemBinding: WaterdisItemBinding) : ViewHolder(itemBinding.root){
